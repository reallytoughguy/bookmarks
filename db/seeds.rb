...
b11 = Book.create(title: "Doubting Thomas", author: "Brandt Blimkie", description: "A riveting exploration of faith in today's world.", publisher: "BB Press", weeks_on_list: 104, rank_this_week: 11)
b12 = Book.create(title: "Love, or Something Like It", author: "Brandt Blimkie", description: "A riveting exploration of love.", publisher: "BB Press", weeks_on_list: 208, rank_this_week: 12)
...
Review.create(comment: "Changed my view of faith", author: "New York Times", book_id: b11.id)
Review.create(comment: "I doubt Thomas.", author: "Thomas", book_id: b11.id)

Review.create(comment: "I LOVE LOVE LOVE this book!", author: "Laurn Smith", book_id: b12.id)
Review.create(comment: "I can't believe she said that.", author: "BB", book_id: b12.id)